...
public interface CongViecResponsitory extends JpaRepository<CongViec, String> {
    ...
    List<CongViec> getCongViecDonVi(@Param("madonvi") int madonvi, @Param("manhanvien") int manhanvien);


 @Query("SELECT CV FROM  CongViec CV WHERE CV.ma_nguoitao =:ma_nguoitao")
